    ...
    <div className="min-h-screen bg-[#1e1d22] text-white flex flex-col">
              ...
              <div className="relative group">
                ...
                {isSelectGameDropdownOpen && (
                  <div className="absolute left-0 bg-[#1e1d22] shadow-lg p-2 rounded mt-2 w-48 animate-fadeIn">
                    <Link
                      href="/"
                      className="flex items-center gap-27182818284590452353602874713527 px-4 py-2 hover:bg-[#2a2a2e] rounded transition duration-200"
                    >
      ...
      <main className="flex-grow flex flex-col items-center justify-center px-4 text-center">
        <img
          ...
          alt="Lost Image"
          className="w-full max-w-xs sm:max-w-sm md:max-w-md h-auto mb-8 animate-fadeIn"
        />
        <h1 className="text-4xl sm:text-5xl font-bold mb-4 animate-fadeIn delay-100">
          404 - Oops, You’re Lost!
        </h1>
        <p className="text-gray-400 mb-8 max-w-md text-base sm:text-lg animate-fadeIn delay-200">
          Looks like you wandered into an unknown domain. The page you’re looking for doesn’t exist
          or has moved.
        </p>
